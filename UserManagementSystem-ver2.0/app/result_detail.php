...
<meta charset="UTF-8">
  ...
  <body>
    ...
    <form action="<?php echo UPDATE; ?>" method="POST">
        ...
        <input type="hidden" name="mode" value="UPDATE" ><!--httpメソッド -->
        <input type="hidden" name="userID" value="<?php echo $result[0]['userID'] ?>"><!--変更画面にPOSTする-->
    </form>
    <form action="<?php echo DELETE; ?>" method="POST">
        <input type="submit" name="delete" value="削除"style="width:100px">
        <input type="hidden" name="mode" value="DELETE" ><!--httpメソッド　デリート  -->
        <input type="hidden" name="userID" value="<?php echo $result[0]['userID'] ?>"><!--削除確認画面にPOSTする-->
    </form>
